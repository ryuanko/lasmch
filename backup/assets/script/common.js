...
function tabList() {
    if ($(window).width() < 740) {
        ...
        $('.section.s-board > li').hide();
        $('.section.s-board > li').eq(0).show();
        ...
        $('.section-title2 h3 a').on('click', function () {
            var idx = $(this).parents('li').attr('data-slick-index');
            $('.section-title2 a').removeClass('on');
            $(this).addClass('on');
            $('.section.s-board > li').hide();
            $('.section.s-board > li').eq(idx).show();
        });
    } else {
        $('.section > li').show();
        $('.section.s-board > li').show();
    }
